...
dependencies {
    ...
    shade("com.fasterxml.jackson.core:jackson-core:2.22.2")
    shade("com.fasterxml.jackson.core:jackson-databind:2.22.2")
    shade("com.fasterxml.jackson.datatype:jackson-datatype-jsr310:2.22.2")
}
